...
<body class="bg-gray-100 min-h-screen">
    ...
    <nav class="bg-[#f5e6d3] p-4 shadow-md fixed w-full top-0 z-50">
        <div class="max-w-7xl mx-auto flex justify-between items-center">
            ...
            <a href="{{ route('cashier.dashboard') }}" class="flex items-center gap-2 text-gray-600 hover:text-[#d4a373] transition-colors font-medium">
        ...
        <div id="mobile-menu" class="md:hidden hidden flex-col gap-2 bg-[#f5e6d3] px-4 py-4 rounded-b-lg shadow-lg">
            ...
            <a href="{{ route('cashier.dashboard') }}" class="block py-2 text-gray-700 hover:text-[#d4a373]">Kasa</a>
