    ...
    <nav class="bg-[#f5e6d3] p-4 shadow-md fixed w-full top-0 z-50">
        <div class="max-w-7xl mx-auto flex justify-between items-center">
            <div class="text-2xl font-bold flex items-center gap-1">
                <a href="{{ route('waiter.dashboard') }}" class="flex items-center gap-1">
                {{ $settings->name ?? 'Restaurant' }}<sup><i class="fa-solid fa-mug-saucer text-[#d4a373]"></i></sup> <span class="text-gray-600 text-lg">Garson</span>
                </a>
            </div>
            ...
            <div class="hidden md:flex items-center gap-4">
                <a href="{{ route('waiter.dashboard') }}" class="flex items-center gap-2 text-gray-600 hover:text-[#d4a373] transition-colors font-medium">
        ...
        <div id="mobile-menu" class="md:hidden hidden flex-col gap-2 bg-[#f5e6d3] px-4 py-4 rounded-b-lg shadow-lg">
            ...
            <a href="{{ route('waiter.dashboard') }}" class="block py-2 text-gray-700 hover:text-[#d4a373]">Garson</a>
